...
import static com.sinem.FitMeApp.exception.ErrorType.*;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(FitMeAppManagerException.class)
    @ResponseBody
    public ResponseEntity<ErrorMessage> handleMonolitichException(FitMeAppManagerException ex){
